...
# Fighter Card 1: Adventurer's Sword
fighter_card_1 = Card(
    "Adventurer's Sword",
    Rarity.SUPER_RARE,
    Cost.EVEN,
...
# Fighter Card 2: Adventurer's Potion
fighter_card_2 = Card(
    "Adventurer's Potion",
    Rarity.SUPER_RARE,
    Cost.ODD,
...
# Thief Card 1: Adventurer's Dagger
thief_card_1 = Card(
    "Adventurer's Dagger",
    Rarity.SUPER_RARE,
    Cost.ANY
...
# Thief Card 2: Adventurer's Rock
thief_card_2 = Card(
    "Adventurer's Rock",
    Rarity.SUPER_RARE,
    Cost.ANY
